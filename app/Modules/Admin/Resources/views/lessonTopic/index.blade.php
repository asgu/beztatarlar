...
@section('title', 'Топики')

@section('content_header')
    <h1 class="m-0 text-dark">Топики</h1>
@stop
...
@section('content')
    ...
    <div class="form-group">
        <a class="btn btn-success" href="{{ route('lessonTopic.create', $lessonId) }}">
            Добавить топик
        </a>
    </div>
                    ...
                    <table class="table table-bordered" id="table">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    {!! Form::text('priority', null, ['class' => 'form-control', 'placeholder' => 'Порядок']) !!}
                                </td>
                                <td>
    ...
    <script>
        $(function () {
            $('#table').DataTable({
                ...
                serverSide: true,
                searching: true,
                ajax: '{{ route('lessonTopic.data', $lessonId) }}',
                columns: [
                    {data: 'id', name: 'id'},
