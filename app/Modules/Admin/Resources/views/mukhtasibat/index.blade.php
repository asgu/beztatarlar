...
@section('title', 'Мухтасибаты')

@section('content_header')
    <h1 class="m-0 text-dark">Мухтасибаты</h1>
@stop
...
@section('content')
    ...
    <div class="form-group">
        <a class="btn btn-success" href="{{ route('mukhtasibat.create') }}">
            Добавить мухтасибат
        </a>
    </div>
                    ...
                    <table class="table table-bordered" id="table">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    {!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Мухтасибат']) !!}
                                </td>
                                <td>
